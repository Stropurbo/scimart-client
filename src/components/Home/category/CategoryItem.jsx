...
const CategoryItem = ({category, index}) => {
    ...
    return (
            ...
            <div className={`w-full md:w-60 h-40 px-2 m-2 md:m-2 md:px-3 rounded-lg  
                ${gradients[index % gradients.length]}`}>
            <div className='flex justify-between pt-5'>
                <p className='flex justify-center items-center rounded-4xl bg-fuchsia-500 text-white font-bold
                h-8 w-8 text-center p-2'> {category.name.charAt(0)} </p>
